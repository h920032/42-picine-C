...
/*   Updated: 2019/07/21 17:58:56 by hsshih           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_pos_cul(int src[9][9], int pos[9][9], int mark[9][9][9])
{
	int	one;
	int	two;
	int	nbr;
	...
	while (one < 9)
	{
		...
		while (two < 9)
		{
			...
			else
			{
				...
				while (nbr <= 9)
				{
					if (ft_set_number(src, one, two, nbr) && mark[one][two][nbr - 1])
						count++;
				}
				pos[one][two] = count;
			}
...
void	ft_sudoku_rec_pos(int src[9][9], int *is_find, int mark[9][9][9])
{
	int	next[9][9];
	int new_mark[9][9][9];
	int	one;
	...
	while (max != 9999)
	{
		...
		while (nbr <= 9)
		{
			if (mark[one][two][nbr - 1] != 1 && ft_set_number
					(src, one, two, nbr))
			{
